...
df_antiga = pd.read_excel(caminho_planilha_antiga, skiprows=13)  # Ajuste o skiprows conforme necessário
...
df_antiga['Quantidade'] = df_antiga['Quantidade'].str.replace(' un', '').astype(int)
